...
-- VIEW 를 이용해서 DML 사용하기

-- DEPARTMENT 테이블 복사한 DEPT_COPY2 생성(TABLE로 생성)
...
VALUES('D0','L2');
--> 가상 테이블 VIEW에 INSERT 가 성공한 것을 확인함
...
-- 가능하면 의도하지 않은 NULL은 존재하지 않게 해야함
...
--> CURRVAL의 정확한 의미는 가장 최근에 호출된 NEXTVAL 값을 반환함을 뜻함
...
INSERT INTO TB_TEST
VALUES (SEQ_TEST_NO.NEXTVAL,'철수'); -- 130 짱구
INSERT INTO TB_TEST
VALUES (SEQ_TEST_NO.NEXTVAL,'유리'); -- 135 짱구
...
-- ROWID : 오라클에서 각 행의 주소를 나타내는 가상 컬럼
