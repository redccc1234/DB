...
------------------------------------------------------------------------------
 ...
 FROM DUAL;
 -- 날짜에 +/- 연산 시 일 단위로 계산이 진행
 
 ------------------------------------------------------------------------------
 
 -- <컬럼 별칭 지정>
 -- 컬럼명 AS 별칭 : 별칭에 띄어쓰기X, 특수문자X, 문자만O 
 -- 컬럼명 AS "별칭" : 별칭에 띄어쓰기O, 특수문자O, 문자만O 
 -- AS 생략 가능
 ...
 -- JAVA 리터럴 : 값 자체를 의미
 -- DE 리터럴 : 임의로 지정한 값을 기존 테이블에 존재하는 값처럼 사용하는 것
 --> DE의 리터럴 표기법 '' 홑따음표
 ...
 -- EMPLOYEE 테이블에서 
 -- 입사일이 1990-01-01 ~ 1999-12-31 사이인 
 -- 직원의 이름,입사일 조회
