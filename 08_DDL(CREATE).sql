...
CREATE TABLE MEMBER (
    ...
    MEMBER_SSN CHAR(14), -- '030214-1234567'
...
COMMENT ON COLUMN MEMBER.MEMBER_SSN IS '회원 주민등번호';
COMMENT ON COLUMN MEMBER.ENROLL_DATE IS '회원 가입일';

-- MEMBER 테이블에 샘플 데이터 삽입
INSERT INTO MEMBER 
VALUES('MEM01','1234ABC','홍길동','123456-1234567',
DEFAULT);
...
INSERT INTO MEMBER 
VALUES('MEM02','QWER123','김영희','234567-2345678',
SYSDATE);
...
INSERT INTO MEMBER2 
VALUES ('MEM01','PASS01','고길동',01012345678);

SELECT * FROM MEMBER2;
--> NUMBER타입 컬럼에 데이터 삽입 시
--  제일 앞에 0이 있으면 이를 자동으로 제거함
--  전화번호,주민등록번호처럼 숫자로만 되어 있는 데이터라도
--  0으로 시작할 가능성이 있으면
--  CHAR , VARCHAR2 같은 문자형 이용!!!
...
VALUES (1,'USER01','PASS01','홍길동','남자','010-1234-5678','hong_gd@kr.or.kr');

INSERT INTO USER_USED_NN 
VALUES (NULL,'USER01','PASS01','홍길동','남자','010-1234-5678','hong_gd@kr.or.kr');
-- ORA-01400 : NULL을 ("KH_CYA"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
-- 단, UNIQUE 제약조건이 설정에 컬럼이 NULL값은 중복 삽입이 가능하다.

-- * 테이블 생성 : 테이블 생성 시 컬럼 정의가 끝난 후 마지막애 작성
...
INSERT INTO USER_USED_UK2 
VALUES (1,'USER02','PASS01','홍길동','남자','010-1234-5678','hong_gd@kr.or.kr');

INSERT INTO USER_USED_UK2 
VALUES (1,'USER02','PASS01','고길동','남자','010-1234-5678','hong_gd@kr.or.kr');

INSERT INTO USER_USED_UK2 
VALUES (1,'USER02','PASS01','고길동','남자','010-1234-5678','hong_gd@kr.or.kr');
-- : ORA-00001: 무결성 제약 조건(KH_CYA.USER_ID_NAME_U)에 위배됩니다
...
-- 한 개의 컬럼에 설정할 수 있고, 복합키로 설정가능(PRTMARY 복합키)
...
INSERT INTO USER_USED_PK 
VALUES (1,'USER02','PASS02','이순신','남자','010-8765-4321','lee@kr.or.kr');
-- ORA-00001: 무결성 제약 조건(KH_CYA.USER_NO_PK)에 위배됩니다
--> 기본키 중복 오류!

INSERT INTO USER_USED_PK 
VALUES (NULL,'USER02','PASS02','이순신','남자','010-8765-4321','lee@kr.or.kr');
-- NULL을 ("KH_CYA"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
--> 기본키에 NULL이므로 오류 !

INSERT INTO USER_USED_PK 
VALUES (2,'USER02','PASS02','이순신','남자','010-8765-4321','lee@kr.or.kr');
-- 삽입 가능 !
...
INSERT INTO USER_USED_PK2 
VALUES (2,'USER02','PASS01','홍길동','남자','010-1234-5678','hong_gd@kr.or.kr');

INSERT INTO USER_USED_PK2 
VALUES (2,'USER02','PASS01','홍길동','남자','010-1234-5678','hong_gd@kr.or.kr');
-- ORA-00001: 무결성 제약 조건(KH_CYA.PK_USERNO_USERID)에 위배됩니다
--> USER_NO,USER_ID 둘 다 중복되었을 때만 제약 조건 위배

INSERT INTO USER_USED_PK2 
VALUES (NULL,'USER02','PASS01','홍길동','남자','010-1234-5678','hong_gd@kr.or.kr');
-- NULL을 ("KH_CYA"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK2 
VALUES (2,NULL,'PASS01','홍길동','남자','010-1234-5678','hong_gd@kr.or.kr');
-- NULL을 ("KH_CYA"."USER_USED_PK2"."USER_ID") 안에 삽입할 수 없습니다

--> 둘 중 하나라도 NULL이면 위배된다!!
...
-- 테이블 레벨일 경우
-- [CONSTRAINT 이름] FOREIGN KEY REFERENCES 참조할 테이블명 [(참조할 컬럼명)] [삭제룰]
...
CREATE TABLE USER_USED_FK(
	...
	--> FOREIGN KEY 명렁어는 테이블 레벨에서만 사용!!
);

INSERT INTO USER_USED_FK 
VALUES (1,'USER01','PASS01','홍길동','남자','010-1234-5678','hong_gd@kr.or.kr',10);
-- USER_GRADE(부모테이블/참조테이블)에 10이라는 GRADE_CODE가 존재하므로
-- 자식테이블이 10이라는 값 사용 가능

INSERT INTO USER_USED_FK 
VALUES (2,'USER02','PASS02','이순신','남자','010-8765-4321','lee@kr.or.kr',10);
-- USER_GRADE(부모테이블/참조테이블)에 10이라는 GRADE_CODE가 존재하므로
-- 자식테이블이 10이라는 값 사용 가능

INSERT INTO USER_USED_FK 
VALUES (3,'USER03','PASS03','유관순','여자','010-1234-1234','yoo@kr.or.kr',30);
-- USER_GRADE(부모테이블/참조테이블)에 10이라는 GRADE_CODE가 존재하므로
-- 자식테이블이 10이라는 값 사용 가능

INSERT INTO USER_USED_FK 
VALUES (4,'USER04','PASS04','안중근','남자','010-5678-5678','an@kr.or.kr',NULL);
--> NULL도 사용 가능

INSERT INTO USER_USED_FK 
VALUES (5,'USER05','PASS05','윤봉길','남자','010-1111-5678','yoon@kr.or.kr',50);
--무결성 제약조건(KH_CYA.GRADE_CODE_FK)이 위배되었습니다- 부모 키가 없습니다
--> 외래키 제약조건에 위배되어 오류 발생(부모의 GRADE_CODE에는 50 값이 없음)
...
-- 1) ON DELETE RESTRICTED(삭제 제한)로 기본 저장되어 있음
-- FOREING KEY로 지정된 컬럼에서 사용되고 있는 값일 경우
-- 제공하는 컬럼의 값은 삭제하지 못함

DELETE FROM USER_GRADE WHERE GRADE_CODE = 30;
-- ORA-02292: 무결성 제약조건(KH_CYA.GRADE_CODE_FK)이 위배되었습니다- 자식 레코드가 발견되었습니다
...
SELECT * FROM USER_USED_FK2; -- 10 -> NULL 10을 사용하고 있던 자식값이 NULL이 됨을 확인
...
-- ON DELETE CASCADE 삭제옵션이 설정되어 있어서 오류 없이 삭제
DELETE FROM USER_GRADE3
WHERE GRADE_CODE = 10;

SELECT * FROM USER_GRADE3; -- 10 삭제됨
SELECT * FROM USER_USED_FK3; -- 부모의 10을 참조하고 있던 자식행이 삭제됨을 확인
...
VALUES (1,'USER01','PASS01','홍길동','남자','010-1234-5678','hong_gd@kr.or.kr');
--ORA-02290: 체크 제약조건(KH_CYA.GENDER_CHECK)이 위배되었습니다

INSERT INTO USER_USED_CHECK 
VALUES (1,'USER01','PASS01','홍길동','남','010-1234-5678','hong_gd@kr.or.kr');
-- 가능

INSERT INTO USER_USED_CHECK
VALUES (2,'USER02','PASS02','이순신','남','010-8765-4321','lee@kr.or.kr');

INSERT INTO USER_USED_CHECK
VALUES (3,'USER03','PASS03','유관순','여','010-1234-1234','yoo@kr.or.kr');

INSERT INTO USER_USED_CHECK
VALUES (4,'USER04','PASS04','안중근','남','010-5678-5678','an@kr.or.kr');
